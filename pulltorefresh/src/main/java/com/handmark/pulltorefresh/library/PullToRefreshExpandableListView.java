...
public class PullToRefreshExpandableListView
  ...
  @TargetApi(9) final class InternalExpandableListViewSDK9 extends InternalExpandableListView {
    ...
    @Override protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY,
      ...
      OverscrollHelper.overScrollBy(PullToRefreshExpandableListView.this, deltaX, scrollX, deltaY,
