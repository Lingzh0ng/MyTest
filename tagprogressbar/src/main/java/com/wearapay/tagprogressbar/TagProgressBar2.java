package com.example.tag_progress;
 ...
 */
public class TagProgressBar2 extends View {
    ...
    public TagProgressBar2(Context context) {
        this(context, null);
    }

    public TagProgressBar2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TagProgressBar2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initCurrentRect() {
        ...
        if (currentProgress == 0) {
            ...
            if (currentProgressWidth > mWidth - getPaddingLeft()) {
                currentProgressWidth = mWidth - getPaddingLeft()-dp2px(15);
            } else if (currentProgressWidth < getPaddingLeft()) {
                currentProgressWidth = getPaddingLeft()+dp2px(15);
            }
        }
